...
export function Offers() {
  const offers = [
    ...
    },
    {
      ...
      features: [
        "Nombre d'invités sur mesure.",
        "Scénographie haut de gamme.",
  ...
  return (
    <section id="formules" className="py-24 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            Des formules pensées pour vos temps forts.
          </motion.h2>
          <motion.p 
             initial={{ opacity: 0, y: 20 }}
             whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Trouvez l'expérience parfaite pour sublimer votre événement et combler vos invités de fraîcheur.
          </motion.p>
        </div>
            ...
            >
              ...
              <div className="px-8 pb-8 flex flex-col flex-grow">
                <div className="text-center mb-6">
                  <h3 className="font-serif text-2xl font-bold text-green-deep mb-2">{offer.title}</h3>
                  <p className="text-text-soft text-sm mb-6 min-h-[40px]">{offer.subtitle}</p>
                  <div className="font-serif text-4xl lg:text-5xl text-green-deep tracking-tight mb-2">
                    {offer.price}
                  </div>
                </div>
